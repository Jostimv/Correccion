 ...
 * @author danny
 */
public class MTableNotas extends AbstractTableModel { // Abstractos: metodos sin cuerpo
    private E_Notas e_notas;

    public E_Notas getE_notas() {
        return e_notas;
    }

    public void setE_notas(E_Notas e_notas) {
    ...
    public int getRowCount() { // Obtener num de filas
        return e_notas.getAlumnos().length;
    /**
    ...
    public Object getValueAt(int i, int i1) { // Obtener valor | srg0: fila | arg1: columna
        switch(i1){
            case 0: return (i+1);
            case 1: return e_notas.getAlumnos()[i];
            case 2: return e_notas.getNotas()[i];
            default: return null;
        }
    }
